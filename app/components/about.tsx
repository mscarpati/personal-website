  ...
  return (
    <div id='me' className={`active ${show ? 'transition-all duration-500' : 'transition-all duration-500 opacity-0'}`}>
      ...
      <div className='mb-20 mt-20'>
        <div className='w-[50rem] md:w-[55rem] bg-light-grey ml-auto mr-auto mt-20 rounded-[30px] items-center justify-center'>
